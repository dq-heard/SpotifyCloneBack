package app.dq_heard.clone_backend.usercontext.application;

import app.dq_heard.clone_backend.usercontext.ReadUserDTO;
import app.dq_heard.clone_backend.usercontext.domain.User;
import app.dq_heard.clone_backend.usercontext.mapper.UserMapper;
import app.dq_heard.clone_backend.usercontext.repository.UserRepository;
...
public class UserService {
  ...
  private void updateUser(User user) {
    Optional<User> optUserUpdate = userRepository.findOneByEmail(user.getEmail());
    if (optUserUpdate.isPresent()) {
      User userToUpdate = optUserUpdate.get();
